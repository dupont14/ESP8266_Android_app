...
const char* ssid = "TP-Link_89CB";                 // Declare your Wi-Fi name here within the double quotes
const char* password = "Password123";             // Declare your Wi-Fi password here within the double quotes
...
void setup() 
{
  ...
  delay(10);
  pinMode(LED_BUILTIN, OUTPUT);                           // set GPIO 0 as OUTPUT
  pinMode(2, OUTPUT);                           // set GPIO 2 as OUTPUT
  digitalWrite(LED_BUILTIN, 0);                           // initially set GPIO 0 as Low
...
{ 
  ...
  digitalWrite(LED_BUILTIN, val1);               // Set GPIO 0 according to the request
  client.flush();
